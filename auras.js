...
export const TIER_ORDER = [
  ...
  'Mythic','Divine','Cosmic','Godly','Femboy','???'
];
...
export const ALL_AURAS = [
  ...
  A('christian','Christian\'s Aura',130,'Mythic',[[80,200,160],[100,240,180],[60,160,130]],22,1,true,false,false,false,'Minty and composed. The calmest person in any given crisis.',3000,800),
  ...
  A('swan','Swan\'s Aura',900,'Mythic',[[255,255,255],[200,240,255],[180,220,255],[220,235,255]],34,2,true,false,false,false,'Soft luminescent white. Pure and poised like still water.',3000,800),
  ...
  A('eric','Eric\'s Aura',2000,'Rare',[[220,140,30],[255,180,60],[180,100,0],[255,220,100]],36,2,true,false,false,true,'Warm amber fire. The kind of energy that turns a boring day into a highlight reel.',80,60),
  // EPIC
  ...
  A('warren','Warren\'s Aura',20000000,'Femboy',[[0,200,180],[0,255,220],[20,80,100],[180,255,240],[200,240,255]],120,6,true,true,true,true,'Deep teal currents — calm on the surface, powerful underneath. One in twenty million.',50000,10000),
  ...
  A('jason','Jason\'s Aura',250000,'Mythic',[[0,40,180],[0,100,255],[80,180,255],[0,20,100]],76,5,true,true,true,true,'Deep ocean blue. Calm, deep, and surprisingly powerful when pushed.',3000,800),
  A('avi','Avi\'s Aura',400000,'Mythic',[[255,220,0],[255,170,0],[200,100,0],[255,255,120]],80,5,true,true,true,true,'Pure solar gold — bright, loud, and impossible to ignore.',3000,800),
  // MYTHIC
